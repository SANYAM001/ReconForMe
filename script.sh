...
echo -e ${RED}"##################################################################"
echo -e ${CP}"        ____  _____           _   _                               #"                                                  
echo -e ${CP}"       |  _ \|___ /  ___ ___ | \ | |                              #"                                                  
echo -e ${CP}"       | |_) | |_ \ / __/ _ \|  \| |                              #"                                                 
echo -e ${CP}"       |  _ < ___) | (_| (_) | |\  |                              #"                                               
echo -e ${CP}"       |_| \_\____/ \___\___/|_| |_|                              #"       
echo -e ${CP}"              Automate Your Bug Bounty R3cOn                      #"                                           
echo -e ${BLUE}"     https://www.linkedin.com/in/sanyam-kakkar-82b6901a9/       #"  
echo -e ${YELLOW}"              Coded By: Sanyam Kakkar                         #"
echo -e ${CG}"              https://github.com/SANYAM001                        #"
echo -e ${RED}"################################################################## \n "
}
d=$(date +"%b-%d-%y %H:%M")
